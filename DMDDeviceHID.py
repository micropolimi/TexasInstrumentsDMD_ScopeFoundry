...
#         print ("Total time: ", time.clock()-t)
    ...
    def save_encoded_sequence(self, images, filename):
        ...
        #     os.makedirs(folder)
        pickle.dump(files, open(filename + '.encd', 'wb'), pickle.HIGHEST_PROTOCOL)
...
#         directory_in_str = "C:\\Programmi laboratorio\\Python\\ScopeFoundryProjects\\DMD_ScopeFoundry\\example_patterns\\"
...
if __name__ == "__main__":
    ...
    try:
        ...
        # directory_in_str = "C:\\Programmi laboratorio\\Patterns\\test_DMD2\\"
        # directory = os.fsencode(directory_in_str)
        # i = 0
        # for file in sorted(os.listdir(directory)):
        #     filename = os.fsdecode(file)
